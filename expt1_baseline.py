...
FILENAME_PREFIX = f'{dir}/expt1_baseline'
...
params_nn = {}
params_nn['closure'] = closure_net.init(jax.random.PRNGKey(1), jnp.zeros((ny, nx, 10)), [jnp.zeros((128,)), jnp.zeros((128,)), jnp.zeros((128,)), jnp.zeros((128,))])['params']
